...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        w1, w2, w3 = weights
        self.conv1.conv1d_stride1.W = np.transpose(np.reshape(w1[:, :2].T, (2, 8, 24))[:, :2, :], (0, 2, 1))
        self.conv2.conv1d_stride1.W = np.transpose(np.reshape(w2[:, :8].T, (8, 4, 2))[:, :2, :], (0, 2, 1))
        self.conv3.conv1d_stride1.W = np.transpose(np.reshape(w3.T, (4, 2, 8)), (0, 2, 1))
